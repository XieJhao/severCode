...
void Logger::Impl::formatTime()
{
  ...
  // printf("microSecondsSinceEpoch=%ld   seconds=%ld   %d   %ld\r\n",microSecondsSinceEpoch,seconds,microseconds,t_lastSecond);
  if (seconds != t_lastSecond)
  {
    ...
    int len = snprintf(t_time, sizeof(t_time), "%04u%02d%02d %02d:%02d:%02d",
        pt->tm_year, pt->tm_mon, pt->tm_mday, pt->tm_hour, pt->tm_min, pt->tm_sec);
    // printf("****:%u  %d %d %02d:%02d:%02d\r\n", pt->tm_year, pt->tm_mon, pt->tm_mday, pt->tm_hour, pt->tm_min, pt->tm_sec);
